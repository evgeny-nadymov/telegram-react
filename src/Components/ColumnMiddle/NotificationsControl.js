...
class NotificationsControl extends React.Component {
  constructor(props) {
    ...
    this.setChatNotificationSettings = this.setChatNotificationSettings.bind(
      this
    );
    this.handleSetChatNotifications = this.handleSetChatNotifications.bind(
      this
    );
    this.onUpdateChatNotificationSettings = this.onUpdateChatNotificationSettings.bind(
      this
    );
    this.onUpdateScopeNotificationSettings = this.onUpdateScopeNotificationSettings.bind(
      this
    );
  }
  ...
  componentDidMount() {
    ChatStore.on(
      ...
      this.onUpdateChatNotificationSettings
    );
    ApplicationStore.on(
