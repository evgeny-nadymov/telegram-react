        ...
        function(a, b, c) {
                ...
                (f.onupgradeneeded = function(b) {
                  ...
                  try {
                    c.createObjectStore(a.storeName),
                      b.oldVersion <= 1 && c.createObjectStore(ka);
                  } catch (c) {
          ...
          function y(a) {
            ...
            f ||
              ...
              (ia[d.name] = f)),
              f.forages.push(c),
              c._initReady || ((c._initReady = c.ready), (c.ready = x));
          ...
          function I(a) {
            ...
            for (b = 0; b < c.length; b += 3)
              (d += na[c[b] >> 2]),
                (d += na[((3 & c[b]) << 4) | (c[b + 1] >> 4)]),
                (d += na[((15 & c[b + 1]) << 2) | (c[b + 2] >> 6)]),
                (d += na[63 & c[b + 2]]);
            return (
              c.length % 3 === 2
            ...
            if (
              ...
              a &&
                ('[object ArrayBuffer]' === c ||
                  (a.buffer && '[object ArrayBuffer]' === Ea.call(a.buffer))))
            ) {
              var d,
                e = qa;
          ...
          var Oa =
            ...
            Pa = (function() {
              function a(b) {
                d(this, a),
                  (this.INDEXEDDB = Ja.INDEXEDDB),
                  (this.LOCALSTORAGE = Ja.LOCALSTORAGE),
                  (this.WEBSQL = Ja.WEBSQL),
                  (this._defaultConfig = da({}, Ma)),
                  (this._config = da({}, this._defaultConfig, b)),
              ...
              return (
                (a.prototype.config = function(a) {
                  if (
                    'object' === ('undefined' == typeof a ? 'undefined' : fa(a))
                  ) {
                    if (this._ready)
                      return new Error(
                ...
                (a.prototype.defineDriver = function(a, b, c) {
                  var d = new ja(function(b, c) {
                    try {
                      ...
                      for (
                        var g = La.concat('_initStorage'), h = 0;
                        h < g.length;
                        h++
                      ) {
                        var i = g[h];
