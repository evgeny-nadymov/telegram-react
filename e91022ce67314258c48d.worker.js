...
/******/ 				importScripts("" + chunkId + "." + "e91022ce67314258c48d" + ".worker.js");
/******/ 			}
/******/ 			resolve();
/******/ 		});
/******/ 	};
              ...
              case 0:
                ...
                return new _promise2.default(function (resolve, reject) {
                  _this.FS.syncfs(false, function () {
                    ...
                    console.log('SYNC: ' + syncfs_time);
                    console.log('SYNC total: ' + _this.syncfs_total_time);
                    resolve();
                  });
                });
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 13:
                ...
                console.log('Failed to init DbFileSystem: ' + _context8.t0);
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 17:
                ...
                console.log('Failed to init TdFileSystem: ' + _context9.t0);
...
var TdClient = function () {
  ...
  (0, _createClass3.default)(TdClient, [{
    ...
    value: function scheduleReceiveIn(timeout) {
      ...
      //return;
      console.log("Scheduler receive in " + timeout + "s");
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                console.log('close worker: start');
                _context11.next = 5;
                return this.tdfs.dbFileSystem.close();

              case 5:
                this.cancelReceive();
                console.log('close worker: finish');
