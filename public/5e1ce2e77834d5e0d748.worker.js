...
/******/ 				importScripts("" + chunkId + "." + "5e1ce2e77834d5e0d748" + ".worker.js");
/******/ 			}
/******/ 			resolve();
/******/ 		});
/******/ 	};
...
var initLocalForage = function () {
        ...
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            memoryDriver = {
              ...
              iterate: function () {
                var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(iteratorCallback) {
                  return _regenerator2.default.wrap(function _callee3$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          _logger2.default.error("iterate is not supported");
              ...
              key: function () {
                var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(n) {
                  return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          _logger2.default.error("key n is not supported");
                  ...
                  return _regenerator2.default.wrap(function _callee5$(_context5) {
                    while (1) {
                      switch (_context5.prev = _context5.next) {
                        case 0:
                          return _context5.abrupt('return', this._map.keys());
                  ...
                  return _regenerator2.default.wrap(function _callee6$(_context6) {
                    while (1) {
                      switch (_context6.prev = _context6.next) {
                        case 0:
                          return _context6.abrupt('return', this._map.size());
              ...
              removeItem: function () {
                var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(key) {
              ...
              setItem: function () {
                var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(key, value) {
                  var originalValue;
                    ...
                    while (1) {
                      switch (_context8.prev = _context8.next) {
                        case 0:
                          ...
                          return _context8.abrupt('return', originalValue);
            ...
            _localforage2.default.defineDriver(memoryDriver);
  ...
  return function initLocalForage() {
    return _ref.apply(this, arguments);
  };
}();

var loadTdLibWasm = function () {
  var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(onFS) {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 3:
            ...
            _logger2.default.info('got td_wasm.js');
            td_wasm = _td_wasm2.default;
            module = Module({
              onRuntimeInitialized: function onRuntimeInitialized() {
                _logger2.default.info('runtime intialized');
              },
              instantiateWasm: function instantiateWasm(imports, successCallback) {
                ...
                (0, _wasmUtils.instantiateAny)(tdlibVersion, td_wasm, imports).then(next);
                return {};
              },
              ENVIROMENT: 'WORKER'
            });

            _logger2.default.info('Got module', module);
            onFS(module.FS);
            TdModule = new _promise2.default(function (resolve, reject) {
              return module.then(function (m) {
                delete m.then;
                resolve(m);
              });
            });
            return _context10.abrupt('return', TdModule);
  ...
  return function loadTdLibWasm(_x7) {
...
var loadTdLibAsmjs = function () {
  var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11(onFS) {
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 3:
            ...
            return _context11.abrupt('return', TdModule);
  ...
  return function loadTdLibAsmjs(_x8) {
    return _ref11.apply(this, arguments);
  };
}();

var loadTdLib = function () {
  var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(mode, onFS) {
    var wasmSupported;
        ...
        switch (_context12.prev = _context12.next) {
          case 0:
            wasmSupported = function () {
              try {
                if ((typeof WebAssembly === 'undefined' ? 'undefined' : (0, _typeof3.default)(WebAssembly)) === "object" && typeof WebAssembly.instantiate === "function") {
            ...
            if (!wasmSupported) {
              _logger2.default.warning("WebAssembly is not supported, trying to use asmjs");
              mode = 'asmjs';
            }
            ...
            return _context12.abrupt('return', loadTdLibAsmjs(onFS));

          case 4:
            return _context12.abrupt('return', loadTdLibWasm(onFS));
  ...
  return function loadTdLib(_x9, _x10) {
    return _ref12.apply(this, arguments);
  };
}();

var _localforage = __webpack_require__(131);
...
var _wasmUtils = __webpack_require__(133);

var _td_wasm = __webpack_require__(134);

var _td_wasm2 = _interopRequireDefault(_td_wasm);

var _td_asmjsJs = __webpack_require__(135);

var _td_asmjsJs2 = _interopRequireDefault(_td_asmjsJs);
...
var localForageDrivers = [_localforage2.default.INDEXEDDB, _localforage2.default.LOCALSTORAGE, 'memoryDriver'];

var OutboundFileSystem = function () {
  function OutboundFileSystem(root, FS) {
    (0, _classCallCheck3.default)(this, OutboundFileSystem);

    this.root = root;
    this.nextFileId = 0;
    this.FS = FS;
    this.files = new _set2.default();
    FS.mkdir(root);
  }

  (0, _createClass3.default)(OutboundFileSystem, [{
    key: 'blobToPath',
...
var InboundFileSystem = function () {
  function InboundFileSystem() {
    (0, _classCallCheck3.default)(this, InboundFileSystem);
  }

  (0, _createClass3.default)(InboundFileSystem, [{
    key: 'load_pids',
    value: function () {
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                _logger2.default.debug('InboundFileSystem::create::keys start');
                _context13.next = 4;
              ...
              case 4:
                ...
                _logger2.default.debug('InboundFileSystem::create::keys ' + keys_time + ' ' + keys.length);
                this.pids = new _set2.default(keys);
    ...
    key: 'persist',
    value: function () {
      var _ref14 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee14(pid, path, arr) {
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              ...
              case 7:
                ...
                _logger2.default.error('Failed persist ' + path + ' ', _context14.t0);
    ...
    key: 'create',
    value: function () {
      var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee15(dbName, root, FS_promise) {
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                ...
                ifs.store = _localforage2.default.createInstance({
                  name: dbName,
              ...
              case 8:
                ...
                _logger2.default.debug('InboundFileSystem::create ' + create_time);
                return _context15.abrupt('return', ifs);

              case 16:
                _context15.prev = 16;
                _context15.t0 = _context15['catch'](1);

                _logger2.default.error('Failed to init Inbound FileSystem: ', _context15.t0);
...
var DbFileSystem = function () {
  function DbFileSystem() {
    (0, _classCallCheck3.default)(this, DbFileSystem);
  }

  (0, _createClass3.default)(DbFileSystem, [{
    key: 'sync',
    value: function () {
              ...
              case 2:
                ...
                return new _promise2.default(function (resolve, reject) {
                  _this.FS.syncfs(false, function () {
                    ...
                    _logger2.default.debug('SYNC: ' + syncfs_time);
                    _logger2.default.debug('SYNC total: ' + _this.syncfs_total_time);
                    resolve();
                  });
                });
    ...
    key: 'create',
    value: function () {
      var _ref19 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee19(root, FS_promise) {
        var readOnly = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
        var start, dbfs, FS, rmrf, dirs, root_dir, key, value, i, dir, create_time;
            ...
            switch (_context19.prev = _context19.next) {
              ...
              case 14:
                rmrf = function rmrf(path) {
                  _logger2.default.debug("rmrf ", path);
                  var info;
                  try {
                  ...
                  _logger2.default.debug("rmrf ", path, info);
                  if (info.node.isFolder) {
                    for (var key in info.node.contents) {
                      rmrf(info.path + '/' + info.node.contents[key].name);
                    }
                    _logger2.default.debug("rmdir ", path);
                    FS.rmdir(path);
                  } else {
                    _logger2.default.debug("unlink ", path);
                    FS.unlink(path);
                  }
                };
                ...
                _context19.t0 = _regenerator2.default.keys(root_dir.node.contents);
              ...
              case 18:
                ...
                _logger2.default.debug("node ", key, value);
              ...
              case 27:
                ...
                _logger2.default.debug('DbFileSystem::create ' + create_time);
                return _context19.abrupt('return', dbfs);

              case 34:
                _context19.prev = 34;
                _context19.t2 = _context19['catch'](1);

                _logger2.default.error('Failed to init DbFileSystem: ', _context19.t2);
...
var TdFileSystem = function () {
  ...
  (0, _createClass3.default)(TdFileSystem, [{
    ...
    key: 'init_fs',
    value: function () {
      var _ref21 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee21(prefix, FS_promise) {
        var FS;
          ...
          while (1) {
            switch (_context21.prev = _context21.next) {
              ...
              case 2:
                ...
                FS.mkdir(prefix);
                return _context21.abrupt('return', FS);
    ...
    key: 'create',
    value: function () {
      var _ref22 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee22(prefix, FS_promise) {
        var readOnly = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
        var tdfs, inboundFileSystem, dbFileSystem, FS;
          ...
          while (1) {
            switch (_context22.prev = _context22.next) {
              case 0:
                ...
                inboundFileSystem = InboundFileSystem.create(prefix, prefix + '/inboundfs', FS_promise);

                //IDBFS. MEMFS which is flushed to IDB from time to time

                dbFileSystem = DbFileSystem.create(prefix + '/dbfs', FS_promise, readOnly);
                _context22.next = 8;
                return FS_promise;
              ...
              case 8:
                ...
                tdfs.outboundFileSystem = new OutboundFileSystem(prefix + '/outboundfs', tdfs.FS);

                _context22.next = 13;
                return inboundFileSystem;

              case 13:
                tdfs.inboundFileSystem = _context22.sent;
                _context22.next = 16;
                return dbFileSystem;

              case 16:
                tdfs.dbFileSystem = _context22.sent;
                return _context22.abrupt('return', tdfs);

              case 20:
                _context22.prev = 20;
                _context22.t0 = _context22['catch'](0);

                _logger2.default.error('Failed to init TdFileSystem: ', _context22.t0);
...
var TdClient = function () {
  function TdClient(callback) {
    ...
    _logger2.default.info('Start worker');
    this.pendingQueries = [];
    this.isPending = true;
  ...
  (0, _createClass3.default)(TdClient, [{
    ...
    value: function () {
      var _ref23 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee23() {
        ...
        return _regenerator2.default.wrap(function _callee23$(_context23) {
          while (1) {
            switch (_context23.prev = _context23.next) {
              ...
              case 2:
                DRIVERS = [_localforage2.default.INDEXEDDB, 'memoryDriver', _localforage2.default.LOCALSTORAGE, _localforage2.default.WEBSQL, localForageDrivers];
        ...
        }, _callee23, this, [[6, 35, 39, 47], [11, 27], [40,, 42, 46]]);
      }));
    ...
    key: 'init',
    value: function () {
      var _ref24 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee24(options) {
        var _this2 = this;

        var mode, self, FS_promise, prefix, tdfs_promise;
          ...
          while (1) {
            switch (_context24.prev = _context24.next) {
              ...
              case 2:
                ...
                self = this;
                FS_promise = new _promise2.default(function (resolve) {
                  self.onFS = resolve;
                });
    ...
    value: function prepareQueryRecursive(query) {
      ...
      for (var key in query) {
        var field = query[key];
        if (field && (typeof field === 'undefined' ? 'undefined' : (0, _typeof3.default)(field)) === 'object') {
    ...
    value: function send(query) {
      ...
      if (query['@type'] === 'start') {
        _logger2.default.info('on_start');
        this.onStart();
        return;
      }
    ...
    value: function scheduleReceiveIn(timeout) {
      ...
      //return;
      _logger2.default.debug('Scheduler receive in ' + timeout + 's');
    ...
    key: 'close',
    value: function () {
      var _ref25 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee25(last_update) {
        return _regenerator2.default.wrap(function _callee25$(_context25) {
          while (1) {
            switch (_context25.prev = _context25.next) {
              ...
              case 5:
                this.cancelReceive();
                _logger2.default.debug('close worker: finish');
    ...
    key: 'destroy',
    value: function () {
      var _ref26 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee26(result) {
          ...
          while (1) {
            switch (_context26.prev = _context26.next) {
              ...
              case 7:
                ...
                _logger2.default.error('Failed destroy', _context26.t0);
    ...
    value: function () {
      var _ref27 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee27(error) {
    ...
    value: function saveFile(pid, file) {
      ...
      try {
        ...
        if (arr) {
          file = (0, _assign2.default)({}, file);
          file.arr = arr;
          this.doSaveFile(pid, file, arr);
        }
      } catch (e) {
        _logger2.default.error('Failed to readFile: ', e);
      }
      return file;
    }
  }, {
    key: 'doSaveFile',
    value: function () {
      var _ref28 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee28(pid, file, arr) {
    ...
    value: function flushPendingQueries() {
      ...
      try {
        for (var _iterator2 = (0, _getIterator3.default)(this.pendingQueries), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var client = new TdClient(function (e) {
  ...
  (0, _createClass3.default)(Logger, [{
    ...
    value: function setVerbosity(level) {
      ...
      if (typeof level === 'string') {
        level = { ERROR: 1, WARNING: 2, INFO: 3, LOG: 4, DEBUG: 4 }[level.toUpperCase()] || 2;
      }
      this.level = level;
    }
  }, {
...
exports.instantiateAny = exports.instantiateStreaming = undefined;
...
var instantiateStreaming = exports.instantiateStreaming = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(url, importObject) {
    var result;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function instantiateStreaming(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

var instantiateAny = exports.instantiateAny = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(version, url, importObject) {
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
  ...
  return function instantiateAny(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
  ...
  function lookupInDatabase(db) {
    return new _promise2.default(function (resolve, reject) {
      ...
      request.onsuccess = function (event) {
        if (request.result) resolve(request.result);else reject('Module ' + url + ' was not found in wasm cache');
      };
    });
  }
...
module.exports = __webpack_require__.p + "04049015109083df5181f0ff52300b73.wasm";

/***/ }),
/* 135 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "0d9199dbc5e239f30b1d6fd11e525010.mem";
