...
/******/ 				importScripts("" + chunkId + "." + "cecea2045437f57a0c3e" + ".worker.js");
/******/ 			}
/******/ 			resolve();
/******/ 		});
/******/ 	};
...
var _localforage = __webpack_require__(128);
...
var _wasmUtils = __webpack_require__(130);

var _td_wasm = __webpack_require__(131);

var _td_wasm2 = _interopRequireDefault(_td_wasm);

var _detectBrowser = __webpack_require__(132);
...
var InboundFileSystem = function () {
  ...
  (0, _createClass3.default)(InboundFileSystem, [{
    ...
    key: 'persist',
    value: function () {
      var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(pid, path, arr) {
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 7:
                ...
                _logger2.default.error('Failed persist ' + path + ' ', _context12.t0);
    ...
    key: 'create',
    value: function () {
      var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(dbName, root, FS) {
        var ifs, keys;
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                _context13.next = 8;
                return ifs.store.keys();

              case 8:
                keys = _context13.sent;


                ifs.pids = new _set2.default(keys);
                return _context13.abrupt('return', ifs);

              case 13:
                _context13.prev = 13;
                _context13.t0 = _context13['catch'](0);

                _logger2.default.error('Failed to init Inbound FileSystem: ', _context13.t0);
          ...
          while (1) {
            switch (_context19.prev = _context19.next) {
              case 0:
                ...
                tdfs.outboundFileSystem = new OutboundFileSystem(prefix + '/outboundfs', FS);

                //MEMFS. Store to IDB and delete files as soon as possible
                inboundFileSystem = InboundFileSystem.create(prefix, prefix + '/inboundfs', FS);
...
var TdClient = function () {
  ...
  (0, _createClass3.default)(TdClient, [{
    ...
    value: function () {
      ...
      function asyncOnFatalError(_x23) {
    ...
    key: 'doSaveFile',
    value: function () {
      var _ref25 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee25(pid, file, arr) {
      ...
      function doSaveFile(_x24, _x25, _x26) {
...
module.exports = __webpack_require__.p + "3f24dd442459707cf08c492254fede1c.wasm";
...
function getNodeVersion() {
  ...
  return isNode ? {
    ...
    os: __webpack_require__(133).type().toLowerCase()
  } : null;
}
